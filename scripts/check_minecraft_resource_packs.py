    ...
    def test_manifest_uuid_and_archive_contract(self):
        ...
        for pack in RESOURCE_PACKS:
            ...
            for section in [doc["header"], *doc["modules"]]:
                ...
                self.assertEqual(section["version"], [1, 1, 0] if pack == AQUARIUM_GLASS else [1, 0, 0])
    ...
    def test_direct_content_only_bumps_its_pack_after_six_pack_install(self):
        ...
        with tempfile.TemporaryDirectory() as temporary:
            ...
            for pack in RESOURCE_PACKS:
                ...
                self.assertEqual(version, [1, 1, 0] if pack == "resource_packs/ichiyon_aquarium_glass_rp/" else [1, 0, 1] if pack == VIDEO_BIG else [1, 0, 0])
                if pack != VIDEO_BIG:
